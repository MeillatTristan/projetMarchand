	...
	<body>
		...
		<!----- start-header---->
			<div id="home" class="header">
					<div class="top-header">
						...
						<!----start-top-nav---->
						 <nav class="top-nav">
							<ul class="top-nav">
								<li><a href="legume.php" class="scroll">Légumes</a></li>
								<li class="fruit.php"><a href="fruit.php" class="scroll">Fruits</a></li>
								<li><a href="panier.php" class="scroll">Panier</a></li>
							</ul>
			...
			<div id="expand" class="expand">
				<div class="container">
					<div class="expand-info text-center">
						...
						<a class="expand-btn" href="#">Join Us</a>
					</div>
				...
				<div class="container">
					...
					<div class="portfolio logo1 mix_all port-big-grid" data-cat="logo" style="display: inline-block; opacity: 1;">
						<div class="portfolio-wrapper">		
							<a data-toggle="modal" data-target=".bs-example-modal-md" href="images/p2.jpg" class="b-link-stripe b-animate-go  thickbox swipebox">
					...
					<div class="portfolio app mix_all" data-cat="app" style="display: inline-block; opacity: 1;">
						<div class="portfolio-wrapper">		
							<a data-toggle="modal" data-target=".bs-example-modal-md" href="images/p3.jpg" class="b-link-stripe b-animate-go  thickbox swipebox">
					...
					<div class="portfolio web mix_all" data-cat="web" style="display: inline-block; opacity: 1;">
						<div class="portfolio-wrapper">		
							<a data-toggle="modal" data-target=".bs-example-modal-md" href="images/p4.jpg" class="b-link-stripe b-animate-go  thickbox swipebox">
					...
					<div class="portfolio icon mix_all" data-cat="icon" style="display: inline-block; opacity: 1;">
						<div class="portfolio-wrapper">		
							<a data-toggle="modal" data-target=".bs-example-modal-md" href="images/p1.jpg" class="b-link-stripe b-animate-go  thickbox swipebox">
					...
					<div class="portfolio app mix_all" data-cat="app" style="display: inline-block; opacity: 1;">
						<div class="portfolio-wrapper">		
							<a data-toggle="modal" data-target=".bs-example-modal-md" href="images/p5.jpg" class="b-link-stripe b-animate-go  thickbox swipebox">
					...
					<div class="portfolio card mix_all" data-cat="card" style="display: inline-block; opacity: 1;">
						<div class="portfolio-wrapper">		
							<a data-toggle="modal" data-target=".bs-example-modal-md" href="images/p6.jpg" class="b-link-stripe b-animate-go  thickbox swipebox">
					...
					<div class="team-members text-center">
						<div class="col-md-4">
							<div class="team-member">
								<img src="images/t1.png" title="name" />
								<h5><span>Tomothy </span>Bowman</h5>
						...
						<div class="col-md-4">
							<div class="team-member">
								<img src="images/t2.png" title="name" />
								<h5><span>Steve </span>Tracy</h5>
								<label>CEO</label>
								<ul class="unstyled-list">
									<li><a class="twitter" href="#"><span> </span></a></li>
									<li><a class="facebook" href="#"><span> </span></a></li>
						...
						<div class="col-md-4">
							<div class="team-member">
								<img src="images/t3.png" title="name" />
								<h5><span>Hellen </span>Johns</h5>
								<label>Clients	</label>
								<ul class="unstyled-list">
									<li><a class="twitter" href="#"><span> </span></a></li>
									<li><a class="facebook" href="#"><span> </span></a></li>
			...
			<div class="testmonials text-center">
				<div class="container">
					<img class="text-center test-icon" src="images/test-icon.png" title="name" />
							...
							<link href="css/owl.carousel.css" rel="stylesheet">
							 ...
							 <!-- start content_slider -->
						       <div id="owl-demo" class="owl-carousel">
					                <div class="item">
					                	<div class="testmonial-people">
					                		<div class="col-md-5 test-info">
					                			<p>This is Photoshop's version  of Lorem Ipsum. Proin gravida nibh vel velit auctor aliquet. Aenean sollicitudin, lorem quis bibendum auctor, nisi elit conse</p>
					                		</div>
					                		<div class="col-md-3 test-people text-center">
					                			<img src="images/test-people.png" title="name" />
					                		</div>
					                		<div class="col-md-3 test-people-name text-left">
					                			<h4><span>Alan</span> Richman</h4>
					                			<label>CEO of Romashka</label>
					                		</div>
					                		<div class="clearfix"> </div>
					                	</div>
					                </div>
			...
			<div id="contact" class="address">
				...
				<div class="map">
					<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d6492831.879838215!2d-102.04805634196835!3d37.38207314531542!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x54eab584e432360b%3A0x1c3bb99243deb742!2sUnited+States!5e0!3m2!1sen!2sin!4v1403540089700"></iframe>
				</div>
			</div>
			<!---- Address ---->
			<!---- footer ---->
